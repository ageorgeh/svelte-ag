...
export function getAriaOrientation(orientation: 'horizontal' | 'vertical'): 'horizontal' | 'vertical' {
  return orientation;
}
...
export function getDataOrientation(orientation: 'horizontal' | 'vertical'): 'horizontal' | 'vertical' {
  return orientation;
}
